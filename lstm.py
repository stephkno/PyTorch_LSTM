...
def train_cycle(model, temperature):
    ...
    while True:
        ...
        while t < steps:
            ...
            if t % 10 == 0:
                txt = colored("\r ▲ {} | Training | Progress: {}% | {}/{} | Epoch: {} | Batch: {} | {} | {} | {} |".format(model.count, progress, model.counter, len(text), model.epochs, model.batches, f, c, alphabet[new_letter]),
                          attrs=['reverse'])
                print(txt,end="")
